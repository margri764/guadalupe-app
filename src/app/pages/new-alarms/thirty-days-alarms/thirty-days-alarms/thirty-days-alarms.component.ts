...
@Component({
  selector: 'app-thirty-days-alarms',
  standalone: true,
  imports: [CommonModule, MaterialModule, RouterModule, MatSortModule],
  templateUrl: './thirty-days-alarms.component.html',
  styleUrl: './thirty-days-alarms.component.scss'
})
export class ThirtyDaysAlarmsComponent {
