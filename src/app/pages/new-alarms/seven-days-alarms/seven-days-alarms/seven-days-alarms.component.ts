import { Component, Input, OnChanges, OnDestroy, OnInit, SimpleChanges, ViewChild, input } from '@angular/core';
...
@Component({
  selector: 'app-seven-days-alarms',
  standalone: true,
  imports: [CommonModule, MaterialModule, RouterModule, MatSortModule, SevenDaysAlarmsComponent],
  templateUrl: './seven-days-alarms.component.html',
  styleUrl: './seven-days-alarms.component.scss'
})
export class SevenDaysAlarmsComponent implements OnChanges {
